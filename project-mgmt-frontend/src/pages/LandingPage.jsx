      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block">Keells Project</span>
            <span className="block text-emerald-600">Management System</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Streamlined collaboration for Keells teams and approved suppliers
          </p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <div className="flex items-center">
                ...
                <h3 className="ml-3 text-lg leading-6 font-medium text-gray-900">Keells Employee Access</h3>
              </div>
              <div className="mt-4">
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="mt-4">
                <p className="text-sm text-gray-500">
                  Approved suppliers can view assigned projects, submit deliverables, and communicate with Keells teams.
                </p>
              </div>
      ...
      <footer className="bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <p className="text-center text-base text-gray-400">
            &copy; {new Date().getFullYear()} Keells Supermarket. Internal use only.
          </p>
        </div>
      </footer>
    </div>
